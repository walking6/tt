...
kb = LINETCR.LINE()
kb.login(token="Eoim0B6iRSC3zQaK33we.Z8u7JHOagIMP4RurQt9jhG.bv3wGDo+Afh12BWjGZuWR7sZWxUK6D9Vr8tmmlGTN9k=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="Eon6l6bO251RupMZ7Hk8.1COZ+eyUW15GmPtAm/cuka.twJWS6kTzudSIOTTQCUDiMCeWOSuGhTFC9MfiZrIG/4=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EoKxJFpA6GmBaRDvFduf.28lJ/KNMaYjd9dM+81Tf7W.5FpKi/KiQ0fuyR26vRVrQfg4jJRMuD81qBosAkZ9A0M=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="EorNYJSIbEAH60L2EzSf.DE886d7WJHNnXb6l5FSXJW.rrZmj3ET+Y3uAh86/At4U54QUGxTOHJyFp03CVkL+Ww=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="Eo2vsuiKdP49IV7UrOx6.iL3I0xRHEfMJW3zCYNuoXG.PgPDcUE78FsAXZw73TIfxGfeei4q74vbufpSVpCbovk=")
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="EovM9qwAP7UizLWgpUX5.7engPsy7hbEIyqoqa/MwPq.q77bUbpLqxMn1OmSSivGcS1ZfV4bLpNIviPIMHtcyBQ=")
sw.loginResult()
...
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"ubafe934229c328e2c606793900071c78"]
admin = ["ubafe934229c328e2c606793900071c78"]
staff = ["ubafe934229c328e2c606793900071c78"]
owner = ["ubafe934229c328e2c606793900071c78"]
adminMID = 'ubafe934229c328e2c606793900071c78'
wait ={ 
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "comment":" ᴅᴏɴᴛ ᴋɪᴄᴋ ᴍᴇ fʀᴏᴍ ɢʀᴏᴜᴘ ",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        cl.sendText(op.param1, cl.getContact(op.param3).displayName + " Jangan kick ")
...
#----------------------------------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif msg.text in ["setting","Set","Set view","Setting"]:
	      if msg.from_ in admin:
                md = "  ✮ 「 S͞e͞t͞t͞i͞n͞g͞ B͞oт 」✮\n\n╔══════════════\n"
		...
		if wait["goodbye"] == False:
	      ...
	      if msg.from_ in admin:
            	...
            	msg.contentType = 13
                msg.contentMetadata = {'mid': 'ubafe934229c328e2c606793900071c78'}
                cl.sendMessage(msg)
...
#-----------------------------------------------------------------------
		    ...
		    now2 = datetime.now()
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik「Lurkers」dulu")
...
#-----------------------------------------------                   
	      ...
	      if msg.from_ in admin:
                  ...
                  print "COMMENT DENIED"
#-----------------------------------------------
	    elif msg.text in ["Tag","Tagall","Mentionall"]:
	      if msg.from_ in admin:
                group = cl.getGroup(msg.to)
...
#------------------------[Copy]-------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif "Bot:Bc " in msg.text:
                bctxt = msg.text.replace("Bot:Bc ", "")
...
#_______________
            ...
            elif msg.text in ["Bot leaveAllGc"]:
              if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
...
#-----------------------------------------------------------------------
	    ...
	    elif "Bot del" in msg.text:
	      if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist user succes dibersihkan")

            elif "Bot ban" in msg.text:
              if msg.toType == 2:
                  if msg.from_ in admin:                                        
                       ban0 = msg.text.replace("Bot ban","")
                       ban1 = ban0.lstrip()
                       ban2 = ban1.replace("@","")
                       ban3 = ban2.rstrip()
                       _name = ban3
	      ...
	      if msg.from_ in admin:
		   ...
		   _nametarget = _name.rstrip(' ')
            ...
            elif "Bot talapung" in msg.text:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    print "Fuck"
                    _name = msg.text.replace("Bot talapung","")
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                        if _name in g.displayName:
...
#-----------------------------------------------
		...
		s7 = kg.getProfile()
                s8 = kh.getProfile()
		cl.sendText(msg.to, s.displayName + "  ready")
		ki.sendText(msg.to, s1.displayName + " ready")
                kk.sendText(msg.to, s2.displayName + " ready")
                kc.sendText(msg.to, s3.displayName + " ready")
                kb.sendText(msg.to, s4.displayName + " ready")
                kd.sendText(msg.to, s5.displayName + " ready")
                ke.sendText(msg.to, s6.displayName + " ready")
		kg.sendText(msg.to, s7.displayName + " ready")
                kh.sendText(msg.to, s8.displayName + " ready")
#-----------------------------------------------
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        ki.sendText(op.param1,"Haddeuh dikunci")
                   ...
                   if wait["commentOn"] == True:
                      if posts["userInfo"]["writerMid"] in wait["commentBlack"]:
                         pass
                          ...
                          cl.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["Autolike by: Walking"])
        except:
            count += 1
            if(count == 50):
                sys.exit(0)
